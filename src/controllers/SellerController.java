...
public class SellerController implements Operations {
        ...
        return new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (name.equals("") || lastName.equals("") || phone.equals("") || address.equals("")) {
                    JOptionPane.showMessageDialog(frameVendedores, "Por favor llene todos los campos", "Falta llenar campos", JOptionPane.ERROR_MESSAGE);
                } else {
                    int id = frameMenu.getSizeSellers();
                    Seller seller = new Seller((id + 1), name, lastName, phone, address);
                    ...
                    JOptionPane.showMessageDialog(frameVendedores, "Se registró correctamente el vendedor", "Registro exitoso", JOptionPane.INFORMATION_MESSAGE);
                    model.addRow(a);
                    jTable.setModel(model);
                    frameMenu.setCountSellers(id + 1);
                    cleanFields();
                    // TODO: Modificación de id para interfaz y a la hora de enviar el id.
                    frameVendedores.getJlbEditable().setText("" + (id + 2));
                }
            }
        };
    }
    ...
    private void deleteSeller(int indexThatMatch) {
        ...
        if (input == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showMessageDialog(frameVendedores, "Se eliminó correctamente el cliente",
                    "Eliminación correcta", JOptionPane.INFORMATION_MESSAGE);
            updateTable(indexThatMatch);
        } else if (input == JOptionPane.NO_OPTION) {
            JOptionPane.showMessageDialog(frameVendedores, "No se eliminó nada", "Cancelación de eliminación", JOptionPane.INFORMATION_MESSAGE);
            jTable.getSelectionModel().clearSelection();
        }
    }
